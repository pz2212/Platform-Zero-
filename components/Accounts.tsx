  ...
  return (
    <div className="space-y-6 pb-16">
      ...
      <div className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden min-h-[500px] flex flex-col">
          <div className="border-b border-gray-100 flex overflow-x-auto no-scrollbar bg-gray-50/30">
            {['receivables', 'payables', 'sales'].map((t: any) => (
                <button
                    key={t} onClick={() => setActiveTab(t)}
                    className={`flex-1 min-w-[120px] py-4 text-center font-black text-[10px] uppercase tracking-[0.2em] transition-all border-b-4 ${
              ...
              <div className="space-y-6 animate-in fade-in duration-300">
                <div className="flex flex-col sm:flex-row justify-between items-center gap-4 bg-gray-50/50 p-5 rounded-2xl border border-gray-100">
                    <div className="relative w-full sm:w-80 group">
                        ...
                        <input type="text" placeholder="Search reference or party..." className="w-full pl-11 pr-4 py-3 bg-white border border-gray-200 rounded-xl text-sm font-black text-gray-900 outline-none focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all shadow-sm"/>
                    </div>
